...
class AdminController extends Controller
{
    ...
    function dashboard() {
        $reseps = Resep::with('user')->get(); // Pastikan model Resep memiliki relasi dengan User
    ...
    //ini untuk update nama,email atau password admin di dashboard admin
    ...
    public function kelolaResepUser()
    {
        $reseps = Resep::whereHas('user', function ($query) {
            $query->where('role', 'user'); // Ambil hanya resep dari pengguna
        })->get();
